...
(()=>{
  ...
  load('./scripts-7-base.js',()=>load('./scripts-8.js',()=>load('./scripts-9.js',()=>load('./scripts-10.js',()=>load('./scripts-11.js',()=>load('./scripts-12.js',()=>load('./scripts-13.js')))))));
})();
