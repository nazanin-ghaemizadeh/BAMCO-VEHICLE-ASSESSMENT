...
(()=>{
  ...
  card.innerHTML='<div class="sectionTitle"><div><h2 id="aiDemoTitle"></h2></div></div><div class="comparisonEntryCopy aiDemoEntry"><picture><source media="(prefers-reduced-motion: reduce)" srcset="assets/ai-vehicle-still.png"><img src="assets/ai-vehicle-walk.gif" width="480" height="321" alt="" loading="lazy"></picture><button id="aiReviewStart" type="button" aria-disabled="true"></button></div>';
